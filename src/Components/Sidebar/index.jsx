...
const Sidebar = () => {
    return (
        <div className="sidebar">
            ...
            <Button className="sidebar__box__button" description={GLOBAL.SIDEBAR.BUTTON_PROFILE} icon={<img src={ProfilePic} alt={ProfilePic} className="sidebar__box__button__icon sidebar__box__button__icon--profile"/>}/>
